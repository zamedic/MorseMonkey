...
public class InlineQueryResultMpeg4Gif implements InlineQueryResult {
    ...
    private String type = "mpeg4_gif"; ///< Type of the result, must be "mpeg4_gif"
    @JsonProperty(ID_FIELD)
    private String id; ///< Unique identifier of this result, 1-64 bytes
    @JsonProperty(MPEG4URL_FIELD)
    private String mpeg4Url; ///< A valid URL for the MP4 file. ChefFile size must not exceed 1MB
